  ...
  return (
    <>
      ...
      <div className="container py-5">
        ...
        <p>
          Sitede yer alan ticari unvan, marka, logo, alan adı ve Katip Otomasyonu uzantısı ile benzeri diğer tüm unsur ve içeriklerin fikrî ve sınai mülkiyet hakları veya kullanım lisansı Arkaya Arge Yazılım İnşaat Ticaret Ltd.Şti.'ye aittir. Kullanıcıya yalnızca şahsi kullanım ile sınırlı, münhasır olmayan, devredilemez ve değiştirilemez bir kullanım lisansı verilmektedir. Sitenin tamamı veya bir kısmı ve Katip Otomasyonu uzantısı, herhangi bir yöntemle kopyalanamaz, çoğaltılamaz, dağıtılamaz, yayımlanamaz, ödünç verilemez, içeriği değiştirilemez veya tahrip edilemez.
        </p>
        <p className="mb-4">
